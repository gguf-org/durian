# Streaming LLM Response Support for Durian Agent
...
```
DURIAN_STREAMING_ENABLED=true    # Master switch via env
```
...
try:
    ...
    pass
# Env var override
if os.getenv("DURIAN_STREAMING_ENABLED", "").lower() in ("true", "1", "yes"):
...
| `durian_cli/config.py` | 1 | +streaming config defaults |
