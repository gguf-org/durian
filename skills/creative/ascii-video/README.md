...
Built for [Durian Agent](https://github.com/gguf-org/durian). Usable in any coding agent. Canonical source lives here; synced to [`gguf-org/durian/skills/creative/ascii-video`](https://github.com/gguf-org/durian/tree/main/skills/creative/ascii-video) via PR.
...
| Durian | Durian/checkerboard pattern |
