...
Data file: $DURIAN_HOME/skills/productivity/memento-flashcards/data/cards.json
"""
...
_DURIAN_HOME = Path(os.environ.get("DURIAN_HOME", Path.home() / ".durian"))
DATA_DIR = _DURIAN_HOME / "skills" / "productivity" / "memento-flashcards" / "data"
