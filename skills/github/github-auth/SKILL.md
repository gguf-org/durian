...
- Give it a title like "durian-<machine-name>"
...
elif [ -f ~/.durian/.env ] && grep -q "^GITHUB_TOKEN=" ~/.durian/.env; then
  export GITHUB_TOKEN=$(grep "^GITHUB_TOKEN=" ~/.durian/.env | head -1 | cut -d= -f2 | tr -d '\n\r')
  echo "AUTH_METHOD=curl"
