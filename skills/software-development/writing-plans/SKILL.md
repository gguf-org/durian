...
version: 1.1.0
author: Durian Agent (adapted from obra/superpowers)
license: MIT
metadata:
  durian:
...
> **For Durian:** Use subagent-driven-development skill to implement this plan task-by-task.
...
Use Durian tools to understand the project:
