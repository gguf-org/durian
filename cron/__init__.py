"""
Cron job scheduling system for Durian Agent.
...
Cron jobs are executed automatically by the gateway daemon:
    durian gateway install    # Install as a user service
    sudo durian gateway install --system  # Linux servers: boot-time system service
    durian gateway            # Or run in foreground
