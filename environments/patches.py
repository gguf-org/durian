"""
Monkey patches for making durian tools work inside async frameworks (Atropos).
...
Usage:
    Call apply_patches() once at import time (done automatically by durian_base_env.py).
