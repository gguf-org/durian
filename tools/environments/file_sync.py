...
_FORCE_SYNC_ENV = "DURIAN_FORCE_FILE_SYNC"
...
def iter_sync_files(container_base: str = "/root/.durian") -> list[tuple[str, str]]:
    ...
    the hardcoded /root/.durian to *container_base* because the remote
...
class FileSyncManager:
    ...
    def sync(self, *, force: bool = False) -> None:
        ...
        or ``DURIAN_FORCE_FILE_SYNC=1`` is set.
