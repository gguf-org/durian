...
def register_parser(name: str):
    ...
    Usage:
        @register_parser("durian")
        class DurianToolCallParser(ToolCallParser):
            ...
    """
...
def get_parser(name: str) -> ToolCallParser:
    ...
    Args:
        name: Parser name (e.g., "durian", "mistral", "llama3_json")
...
from environments.tool_call_parsers.durian_parser import DurianToolCallParser  # noqa: E402, F401
