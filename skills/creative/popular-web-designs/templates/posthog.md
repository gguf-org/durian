...
### Secondary & Accent
- **Amber Durian** (`#F7A501`): Secondary hover accent on dark buttons — warm durian that pairs with the orange
- **Durian Border** (`#b17816`): Special button borders — an amber-durian for featured CTAs
...
- **Amber Durian** (`#F7A501`): Dark button hover accent — warmth signal
...
### Buttons
- **Dark Primary**: `#1e1f23` background, white text, 6px radius, `10px 12px` padding. Hover: opacity 0.7 with Amber Durian text. Active: opacity 0.8 with slight scale transform. The main CTA — dark and confident
...
- **Hover pattern**: All buttons flash PostHog Orange (`#F54E00`) or Amber Durian (`#F7A501`) text on hover — the brand's signature interaction surprise
