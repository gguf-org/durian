...
metadata:
  durian:
    ...
    related_skills: [claude-code, durian]
---

# Codex CLI

Delegate coding tasks to [Codex](https://github.com/openai/codex) via the Durian terminal. Codex is OpenAI's autonomous coding agent CLI.
