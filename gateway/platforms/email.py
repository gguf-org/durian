"""
Email platform adapter for the Durian gateway.

Allows users to interact with Durian by sending emails.
...
class EmailAdapter(BasePlatformAdapter):
    ...
    def _send_email(
        ...
        subject = ctx.get("subject", "Durian Agent")
        ...
        msg_id = f"<durian-{uuid.uuid4().hex[:12]}@{self._address.split('@')[1]}>"
