...
4. Name the token (e.g., "Durian Agent"), set an optional expiry, and click **Generate Token**
5. Copy the token and add to `~/.durian/.env`:
...
```bash
CANVAS="python $DURIAN_HOME/skills/productivity/canvas/scripts/canvas_api.py"
