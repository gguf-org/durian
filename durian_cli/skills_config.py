"""
Skills configuration for Durian Agent.
`durian skills` enters this module.

Toggle individual skills or categories on/off, globally or per-platform.
Config stored in ~/.durian/config.yaml under:
...
from durian_cli.platforms import PLATFORMS as _PLATFORMS
