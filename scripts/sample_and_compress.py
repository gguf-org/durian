...
DEFAULT_DATASETS = [
    "gguf-org/swe-terminus-agent-glm-kimi-minimax",
    "gguf-org/durian-megascience-sft1",
    "gguf-org/Durian-Thinking-GLM-4.7-SFT2",
    "gguf-org/Durian-Thinking-GLM-4.7-SFT1",
    "gguf-org/terminal-tasks-glm-durian"
]
...
def load_dataset_from_hf(dataset_name: str) -> List[Dict[str, Any]]:
    ...
    Args:
        dataset_name: HuggingFace dataset name (e.g., "gguf-org/dataset-name")
...
def main(
    ...
    print(f"   huggingface-cli upload gguf-org/{output_name} {final_output}")
