...
_DEFAULT_TOOL_GATEWAY_DOMAIN = "gguf-org.com"
...
def auth_json_path():
    """Return the Durian auth store path, respecting DURIAN_HOME overrides."""
...
def read_nous_access_token() -> Optional[str]:
    ...
    try:
        from durian_cli.auth import resolve_nous_access_token
