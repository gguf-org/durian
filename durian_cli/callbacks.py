...
into prompt_toolkit's event loop. Each function takes the DurianCLI instance
...
from durian_cli.banner import cprint, _DIM, _RST
from durian_cli.config import save_env_value_secure
...
def prompt_for_secret(cli, var_name: str, prompt: str, metadata=None) -> dict:
    ...
    The secret is stored in ~/.durian/.env and never exposed to the model.
    """
