...
Training tasks (3):
    1. Create ~/greeting.txt with "Hello from Durian Agent"
...
TRAIN_TASKS = [
    {
        "prompt": "Create a file at ~/greeting.txt containing exactly the text: Hello from Durian Agent",
        "verify_path": "~/greeting.txt",
        "expected_content": "Hello from Durian Agent",
    },
    {
...
class TerminalTestEnv(DurianAgentBaseEnv):
    ...
    def config_init(cls) -> Tuple[TerminalTestEnvConfig, List[APIServerConfig]]:
        ...
        Claude for inference. API keys loaded from ~/durian/.env.
        """
        env_config = TerminalTestEnvConfig(
            ...
            tokenizer_name="gguf-org/q-30b-t-h45-e1",
