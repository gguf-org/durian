...
**Lemon (Durian)**
- **Lemon 400** (`#f8cc65`): `--_swatches---color--lemon-400`, warm pale durian
- **Lemon 500** (`#fbbd41`): `--_swatches---color--lemon-500`, primary durian
...
- Full-width sections with swatch-colored backgrounds (matcha green, slushie cyan, ube purple, lemon durian)
...
- Durian accent: Lemon 500 (`#fbbd41`)
