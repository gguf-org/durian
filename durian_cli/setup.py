...
_DOCS_BASE = "https://durian.gguf.org/docs"
...
def _setup_slack():
    ...
    print()
    print_info("   Full guide: https://durian.gguf.org/docs/user-guide/messaging/slack/")
    print()
...
def _setup_webhooks():
    ...
    print()
    print_info("   Full guide: https://durian.gguf.org/docs/user-guide/messaging/webhooks/")
    print()
    ...
    print_info("   https://durian.gguf.org/docs/user-guide/messaging/webhooks/#configuring-routes")
    print()
