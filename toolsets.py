...
TOOLSETS = {
    ...
    # ==========================================================================
    # Full Durian toolsets (CLI + messaging platforms)
    #
    ...
    "durian-email": {
        "description": "Email bot toolset - interact with Durian via email (IMAP/SMTP)",
        "tools": _DURIAN_CORE_TOOLS,
        "includes": []
    },
    ...
    "durian-sms": {
        "description": "SMS bot toolset - interact with Durian via SMS (Twilio)",
        "tools": _DURIAN_CORE_TOOLS,
        "includes": []
    },
    ...
    "durian-gateway": {
        ...
        "tools": [],
        "includes": ["durian-telegram", "durian-discord", "durian-whatsapp", "durian-slack", "durian-signal", "durian-bluebubbles", "durian-homeassistant", "durian-email", "durian-sms", "durian-mattermost", "durian-matrix", "durian-dingtalk", "durian-feishu", "durian-wecom", "durian-wecom-callback", "durian-weixin", "durian-qqbot", "durian-webhook"]
    }
}
...
def resolve_toolset(name: str, visited: Set[str] = None) -> List[str]:
    ...
    # Check for cycles / already-resolved (durian deps).
    # Silently return [] — either this is a durian (not a bug, tools already
    ...
    # sibling includes so durian dependencies are only resolved once and
