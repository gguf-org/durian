...
class SlackAdapter(BasePlatformAdapter):
    ...
    async def connect(self) -> bool:
        ...
        tokens_file = get_durian_home() / "slack_tokens.json"
        ...
        try:
            ...
            @self._app.command("/durian")
            async def handle_durian_command(ack, command):
                await ack()
            ...
            for _action_id in (
                "durian_approve_once",
                "durian_approve_session",
                "durian_approve_always",
                "durian_deny",
            ):
                    ...
                    "elements": [
                        {
                            ...
                            "style": "primary",
                            "action_id": "durian_approve_once",
                            "value": session_key,
                        },
                        {
                            "type": "button",
                            "text": {"type": "plain_text", "text": "Allow Session"},
                            "action_id": "durian_approve_session",
                            "value": session_key,
                        },
                        {
                            "type": "button",
                            "text": {"type": "plain_text", "text": "Always Allow"},
                            "action_id": "durian_approve_always",
                            "value": session_key,
                        },
                        {
                            "type": "button",
    ...
    async def _handle_approval_action(self, ack, body, action) -> None:
        ...
        choice_map = {
            "durian_approve_once": "once",
            "durian_approve_session": "session",
            "durian_approve_always": "always",
            "durian_deny": "deny",
        }
    ...
    async def _handle_slash_command(self, command: dict) -> None:
        ...
        from durian_cli.commands import slack_subcommand_map
