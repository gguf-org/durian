#!/usr/bin/env python3
"""Build the Durian Skills Index — a centralized JSON catalog of all skills.
...
`durian skills search/install` can use it without hitting the GitHub API.
...
# Ensure DURIAN_HOME is set (needed by tools/skills_hub.py imports)
os.environ.setdefault("DURIAN_HOME", os.path.join(os.path.expanduser("~"), ".durian"))
...
def main():
    print("Building Durian Skills Index...", flush=True)
