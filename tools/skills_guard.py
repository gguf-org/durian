...
Trust levels:
  - builtin:   Ships with Durian. Never scanned, always trusted.
...
THREAT_PATTERNS = [
    ...
    (r'\$HOME/\.durian/\.env|\~/\.durian/\.env',
     "durian_env_access", "critical", "exfiltration",
     "directly references Durian secrets file"),
    ...
    (r'\.durian/config\.yaml|\.durian/SOUL\.md',
     "durian_config_mod", "critical", "persistence",
     "references Durian configuration files directly"),
