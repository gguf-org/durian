...
Usage:
    durian pairing list              # Show all pending + approved users
    durian pairing approve <platform> <code>  # Approve a pairing code
    durian pairing revoke <platform> <user_id> # Revoke user access
    durian pairing clear-pending     # Clear all expired/pending codes
"""

def pairing_command(args):
    """Handle durian pairing subcommands."""
    ...
    if action == "list":
        ...
        print("Usage: durian pairing {list|approve|revoke|clear-pending}")
        print("Run 'durian pairing --help' for details.")
...
def _cmd_approve(store, platform: str, code: str):
    ...
    if result:
        ...
        print("  Run 'durian pairing list' to see pending codes.\n")
