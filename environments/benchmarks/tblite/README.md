...
- **Dataset (ours):** [gguf-org/openthoughts-tblite](https://huggingface.co/datasets/gguf-org/openthoughts-tblite)
- **Docker images:** `gguf-org/tblite-<task-name>:latest` on Docker Hub (100 images)
...
| Setting        | TB2                              | TBLite                                  |
|----------------|----------------------------------|-----------------------------------------|
| Dataset        | `gguf-org/terminal-bench-2`  | `gguf-org/openthoughts-tblite`      |
| Tasks          | 89                               | 100                                     |
