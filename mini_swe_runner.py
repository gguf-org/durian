#!/usr/bin/env python3
"""
SWE Runner with Durian Trajectory Format

A runner that uses Durian's built-in execution environments
(local, docker, modal) and outputs trajectories in the Durian format
compatible with batch_runner.py and trajectory_compressor.py.

Features:
- Uses Durian's Docker, Modal, or Local environments for command execution
- Outputs trajectories in Durian format (from/value pairs with <tool_call>/<tool_response> XML)
...
# ============================================================================
# Terminal Tool Definition (matches Durian format)
# ============================================================================
...
def create_environment(
    ...
    **kwargs
    ...
    """
    Create an execution environment using Durian's built-in backends.
...
# ============================================================================
# Mini-SWE Runner with Durian Trajectory Format
# ============================================================================

class MiniSWERunner:
    """
    Agent runner that uses Durian's built-in execution environments
    and outputs trajectories in Durian format.
    """
    ...
    def _convert_to_durian_format(
        ...
        """
        Convert internal message format to Durian trajectory format.
...
Complete the user's task step by step."""
        ...
        # Convert to Durian trajectory format
        trajectory = self._convert_to_durian_format(messages, task, completed)
...
def main(
    ...
    """
    Run SWE tasks with Durian trajectory format output.
    ...
    """
    print("🚀 Mini-SWE Runner with Durian Trajectory Format")
    print("=" * 60)
