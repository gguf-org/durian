...
class MemoryProvider(ABC):
    ...
    def initialize(self, session_id: str, **kwargs) -> None:
        ...
        kwargs always include:
          - durian_home (str): The active DURIAN_HOME directory path. Use this
            for profile-scoped storage instead of hardcoding ``~/.durian``.
        ...
        kwargs may also include:
          ...
          - agent_workspace (str): Shared workspace name (e.g. "durian").
    ...
    def get_config_schema(self) -> List[Dict[str, Any]]:
        ...
        Used by 'durian memory setup' to walk the user through configuration.
    ...
    def save_config(self, values: Dict[str, Any], durian_home: str) -> None:
        """Write non-secret config to the provider's native location.

        Called by 'durian memory setup' after collecting user inputs.
        ``values`` contains only non-secret fields (secrets go to .env).
        ``durian_home`` is the active DURIAN_HOME directory path.
