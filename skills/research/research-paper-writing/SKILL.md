...
- [ ] Attention checks / durian standard items (10-15% of total)
...
## Durian Agent Integration

This skill is designed for the Durian agent. It uses Durian tools, delegation, scheduling, and memory for the full research lifecycle.

### Related Skills

Compose this skill with other Durian skills for specific phases:
...
| **plan** | Phase 0 (Setup): creating structured plans before execution. Writes to `.durian/plans/` | `skill_view("plan")` |
