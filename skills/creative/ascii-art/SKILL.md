...
echo "Hello World" | boxes -d durians        # Durian pattern
...
```bash
python3 -m pyfiglet "DURIAN" -f slant | boxes -d stone
# Or without pyfiglet installed:
curl -s "https://asciified.thelicato.io/api/v2/ascii?text=DURIAN&font=Slant" | boxes -d stone
```
