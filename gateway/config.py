...
class GatewayConfig:
    ...
    # Storage paths
    sessions_dir: Path = field(default_factory=lambda: get_durian_home() / "sessions")
    ...
    def from_dict(cls, data: Dict[str, Any]) -> "GatewayConfig":
        ...
        sessions_dir = get_durian_home() / "sessions"
...
def load_gateway_config() -> GatewayConfig:
    ...
    2. ~/.durian/config.yaml (primary user-facing config)
    3. ~/.durian/gateway.json (legacy — provides defaults under config.yaml)
    4. Built-in defaults
    """
    _home = get_durian_home()
    gw_data: dict = {}
