...
Inspired by: GroceryMind — production Durian agent doing live web research
             across German grocery stores (firecrawl + durian)
"""
...
class WebResearchEnvConfig(DurianAgentEnvConfig):
...
class WebResearchEnv(DurianAgentBaseEnv):
    """
