...
Copies bundled skills from the repo's skills/ directory into ~/.durian/skills/
...
The manifest lives at ~/.durian/skills/.bundled_manifest.
"""
...
def _get_bundled_dir() -> Path:
    ...
    Checks DURIAN_BUNDLED_SKILLS env var first (set by Nix wrapper),
    then falls back to the relative path from this source file.
    """
    env_override = os.getenv("DURIAN_BUNDLED_SKILLS")
    if env_override:
...
def _compute_relative_dest(skill_dir: Path, bundled_dir: Path) -> Path:
    ...
    e.g., bundled/skills/mlops/axolotl -> ~/.durian/skills/mlops/axolotl
    """
...
def sync_skills(quiet: bool = False) -> dict:
    """
    Sync bundled skills into ~/.durian/skills/ using the manifest.
...
if __name__ == "__main__":
    print("Syncing bundled skills into ~/.durian/skills/ ...")
